...
${OBJECTDIR}/Characters/Character.o: Characters/Character.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/Character.o Characters/Character.cpp

${OBJECTDIR}/Characters/Mob.o: Characters/Mob.cpp 
	${MKDIR} -p ${OBJECTDIR}/Characters
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/Mob.o Characters/Mob.cpp

${OBJECTDIR}/Characters/NonPlayerCharacter.o: Characters/NonPlayerCharacter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Characters
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/NonPlayerCharacter.o Characters/NonPlayerCharacter.cpp

${OBJECTDIR}/Characters/PartyMember.o: Characters/PartyMember.cpp 
	${MKDIR} -p ${OBJECTDIR}/Characters
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/PartyMember.o Characters/PartyMember.cpp

${OBJECTDIR}/Characters/PlayerCharacter.o: Characters/PlayerCharacter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Characters
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/PlayerCharacter.o Characters/PlayerCharacter.cpp

${OBJECTDIR}/Characters/Skills/SkillExpClass.o: Characters/Skills/SkillExpClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/Characters/Skills
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/Skills/SkillExpClass.o Characters/Skills/SkillExpClass.cpp

${OBJECTDIR}/Characters/Skills/WeaponSkillExpClass.o: Characters/Skills/WeaponSkillExpClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/Characters/Skills
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Characters/Skills/WeaponSkillExpClass.o Characters/Skills/WeaponSkillExpClass.cpp

${OBJECTDIR}/Events/ChoiceEvent.o: Events/ChoiceEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Events
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Events/ChoiceEvent.o Events/ChoiceEvent.cpp

${OBJECTDIR}/Events/CombatEvent.o: Events/CombatEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Events
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Events/CombatEvent.o Events/CombatEvent.cpp

${OBJECTDIR}/Events/DialogueEvent.o: Events/DialogueEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/Events
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Events/DialogueEvent.o Events/DialogueEvent.cpp
...
${OBJECTDIR}/Items/Item.o: Items/Item.cpp 
	${MKDIR} -p ${OBJECTDIR}/Items
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Items/Item.o Items/Item.cpp

${OBJECTDIR}/Items/UseableItem.o: Items/UseableItem.cpp 
	${MKDIR} -p ${OBJECTDIR}/Items
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Items/UseableItem.o Items/UseableItem.cpp

${OBJECTDIR}/Items/Weapon.o: Items/Weapon.cpp 
	${MKDIR} -p ${OBJECTDIR}/Items
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Items/Weapon.o Items/Weapon.cpp

${OBJECTDIR}/Maps/CombatIcon.o: Maps/CombatIcon.cpp 
	${MKDIR} -p ${OBJECTDIR}/Maps
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Maps/CombatIcon.o Maps/CombatIcon.cpp
...
${OBJECTDIR}/Maps/Tile.o: Maps/Tile.cpp 
	${MKDIR} -p ${OBJECTDIR}/Maps
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Maps/Tile.o Maps/Tile.cpp

${OBJECTDIR}/Menus/CharacterMenu.o: Menus/CharacterMenu.cpp 
	${MKDIR} -p ${OBJECTDIR}/Menus
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menus/CharacterMenu.o Menus/CharacterMenu.cpp

${OBJECTDIR}/Menus/Menu.o: Menus/Menu.cpp 
	${MKDIR} -p ${OBJECTDIR}/Menus
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Menus/Menu.o Menus/Menu.cpp
