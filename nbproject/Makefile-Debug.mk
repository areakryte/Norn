...
${OBJECTDIR}/build/Characters/Character.o: build/Characters/Character.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/build/Characters/Character.o build/Characters/Character.cpp

${OBJECTDIR}/build/Characters/SkillExpClass.o: build/Characters/SkillExpClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/build/Characters
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/build/Characters/SkillExpClass.o build/Characters/SkillExpClass.cpp

${OBJECTDIR}/build/Characters/WeaponSkillExpClass.o: build/Characters/WeaponSkillExpClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/build/Characters
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/build/Characters/WeaponSkillExpClass.o build/Characters/WeaponSkillExpClass.cpp
