...
${OBJECTDIR}/SkillExpClass.o: SkillExpClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SkillExpClass.o SkillExpClass.cpp

${OBJECTDIR}/WeaponSkillExpClass.o: WeaponSkillExpClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WeaponSkillExpClass.o WeaponSkillExpClass.cpp
